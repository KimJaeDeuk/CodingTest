...
public class No13_기초DFS연습_Solution {
	...
	private final static No13_기초DFS연습_UserSolution usersolution = new No13_기초DFS연습_UserSolution();
	...
	public static void main(String[] args) throws Exception {
		System.setIn(new FileInputStream("res/13_input.txt"));
		...
		for (int tc = 1; tc <= TC; tc++) {
			...
			for(int i = 1; i <= Q; i++) {
				...
				System.out.println("결과 : " + ret + " 정답 : " + ans);
				if(ret != ans) score = 0;
			}
